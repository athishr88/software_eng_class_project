...
urlpatterns = [
    ...
    path("staff/sellers/approvals/", views.seller_approvals, name="seller_approvals"),
    path("staff/buyers/approvals/", views.buyer_approvals, name="buyer_approvals"),
    path("staff/sellers/approve/<int:user_id>/", views.approve_seller, name="approve_seller"),
    path("staff/buyers/approve/<int:user_id>/", views.approve_buyer, name="approve_buyer"),
    path("users/list/", views.admin_users, name="admin_users"),
    path("users/<int:user_id>/toggle-freeze/", views.toggle_user_freeze, name="toggle_user_freeze"),
    path("books/", views.admin_books, name="admin_books"),
    path("books/<int:book_id>/toggle-freeze/", views.toggle_book_freeze, name="toggle_book_freeze"),
